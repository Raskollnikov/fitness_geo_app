      ...
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="bg-card/90 backdrop-blur-sm border border-border rounded-lg overflow-hidden mb-16">
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-10">
              იხილე პერსონალიზებული ფიტნეს გეგმები, რომლებიც ჩვენი AI ასისტენტის მიერ სხვა მომხმარებლებისთვის არის შექმნილი
            </p>
            ...
            <div className="flex items-center justify-center gap-16 mt-10 font-mono">
              ...
              <div className="flex flex-col items-center">
                <p className="text-3xl text-primary">3წ</p>
                <p className="text-sm text-muted-foreground uppercase tracking-wide mt-1">
                  შექმნის დრო
                </p>
              </div>
            ...
            >
              ...
              <div className="flex items-center justify-between px-4 py-2 border-b border-border bg-background/70">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-primary">მომხმარებელი {program.id}</span>
                </div>
              ...
              <CardContent className="px-5">
                ...
                <div className="space-y-5 pt-2">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-center">
                        <h3 className="font-medium text-foreground">დაცული პროტოკოლი</h3>
                      </div>
                      <p className="text-sm text-muted-foreground mt-1">
                        მაქსიმალური უსაფრთხოებისათვის
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-muted-foreground mt-4">
            შემოუერთდი 500-ზე მეტ მომხმარებელს AI-დამზადებულ ფიტნეს მოდელთან ერთად ერთად
          </p>
        </div>
      </div>
    </div>
